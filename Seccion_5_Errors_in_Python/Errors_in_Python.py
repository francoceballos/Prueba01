print("Seccion 5: 70. Built in errors in Python")

#Tipos de Errores.
print("IndexError")
print("KeyError")
print("NameError") #Acceder a algo que no existe
...
All built-in errors (what we looked at in the last video) are available everywhere for you to use.
...
ford_garage.add_car(focus)
ford_garage.add_car('Fiesta')  # raises error
print(ford_garage.cars)	#Llama a la funcion repr de cada objeto en la lista.