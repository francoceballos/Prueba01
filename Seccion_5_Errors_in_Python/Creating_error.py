print("Seccion 5: creating our own errors")
...
"""
The `pass` keyword just means “nothing here”. 
It is required because Python expects there to be an indented block after a colon, 
so we must at least have _something_ so Python can see the indentation.
...
raise MyErrorWithCode('A message describing the error', 500)

## Docstrings
"""
Docstrings in Python are just strings that are commonly used to describe 
what a class or function does or when it should be used.
...
"""
It so happens that in Python the triple-quotation mark is a *multi-line string*. 
You can use it instead of a normal string anywhere, if you want multiple lines.
...
"""
Notice how here the multi-line string is in one line; and that’s OK.
We could put it into multiple lines if we want to.
"""