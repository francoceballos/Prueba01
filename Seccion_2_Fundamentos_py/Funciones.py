...
#Buena practica dejar dos saltos de linea entre funciones.
...
#Dar valores predeterminados a las funciones 
...
print(1, 2, 3, 4, 5, sep=" - ")  # default is " "  ; sep ; separación

# You can use almost anything as a default parameter value.
# But using variables as default parameter values is discouraged,
# as that can introduce difficult to spot bugs

default_y = 3

def add(x, y=default_y):  #una vez definida la función el valor asignado a 'y' se guardo por defecto 
    sum = x + y 		  #durante la ejecución de todo el programa
    print(sum)
...
# It's not important to understand this now, but just know that they behave differently to 
# integers and strings behind the scenes when you change them.



#Función lambda: equivalente a inline en lenguaje c
...
# Since the average function just takes inputs and returns an output,
# we could re-define it as a lambda function.
