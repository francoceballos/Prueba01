...
print("Class 4: Herencia en python")
...
class WorkingStudent(Student):					#Se hereda clase Student
    def __init__(self, name, school, salary):
        super().__init__(name, school)			#Se llama al constructor de la clase padre
        self.salary = salary
...
"""
By the way, notice how the `average()` function doesn’t take any inputs other than `self`. 
